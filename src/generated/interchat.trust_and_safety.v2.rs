...
pub struct ReplaceContentPolicyRequest {
    ...
    #[prost(message, optional, tag = "2")]
    pub policy: ::core::option::Option<NativeContentPolicy>,
    /// Zero is create-only. Otherwise this must match the stored aggregate.
    #[prost(uint64, tag = "3")]
...
impl ContentPolicyAuthority {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            Self::Unspecified => "CONTENT_POLICY_AUTHORITY_UNSPECIFIED",
            Self::Global => "CONTENT_POLICY_AUTHORITY_GLOBAL",
            Self::Hub => "CONTENT_POLICY_AUTHORITY_HUB",
            Self::Server => "CONTENT_POLICY_AUTHORITY_SERVER",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl ContentPolicySurface {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            Self::Unspecified => "CONTENT_POLICY_SURFACE_UNSPECIFIED",
            Self::MessageContent => "CONTENT_POLICY_SURFACE_MESSAGE_CONTENT",
            Self::DisplayName => "CONTENT_POLICY_SURFACE_DISPLAY_NAME",
            Self::Username => "CONTENT_POLICY_SURFACE_USERNAME",
            Self::ServerName => "CONTENT_POLICY_SURFACE_SERVER_NAME",
            Self::HubName => "CONTENT_POLICY_SURFACE_HUB_NAME",
            Self::UrlDomain => "CONTENT_POLICY_SURFACE_URL_DOMAIN",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl ContentPatternType {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            Self::Unspecified => "CONTENT_PATTERN_TYPE_UNSPECIFIED",
            Self::ExactWord => "CONTENT_PATTERN_TYPE_EXACT_WORD",
            Self::Prefix => "CONTENT_PATTERN_TYPE_PREFIX",
            Self::Suffix => "CONTENT_PATTERN_TYPE_SUFFIX",
            Self::Contains => "CONTENT_PATTERN_TYPE_CONTAINS",
            Self::Phrase => "CONTENT_PATTERN_TYPE_PHRASE",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
impl ContentPolicyActionType {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            Self::Unspecified => "CONTENT_POLICY_ACTION_TYPE_UNSPECIFIED",
            Self::Allow => "CONTENT_POLICY_ACTION_TYPE_ALLOW",
            Self::Block => "CONTENT_POLICY_ACTION_TYPE_BLOCK",
            Self::CensorMatch => "CONTENT_POLICY_ACTION_TYPE_CENSOR_MATCH",
            Self::StripLink => "CONTENT_POLICY_ACTION_TYPE_STRIP_LINK",
            Self::SuppressLinks => "CONTENT_POLICY_ACTION_TYPE_SUPPRESS_LINKS",
            Self::ReplaceName => "CONTENT_POLICY_ACTION_TYPE_REPLACE_NAME",
            Self::Log => "CONTENT_POLICY_ACTION_TYPE_LOG",
            Self::LobbyWarn => "CONTENT_POLICY_ACTION_TYPE_LOBBY_WARN",
            Self::LobbyBan => "CONTENT_POLICY_ACTION_TYPE_LOBBY_BAN",
            Self::Blacklist => "CONTENT_POLICY_ACTION_TYPE_BLACKLIST",
            Self::HubWarn => "CONTENT_POLICY_ACTION_TYPE_HUB_WARN",
            Self::HubMute => "CONTENT_POLICY_ACTION_TYPE_HUB_MUTE",
            Self::HubBan => "CONTENT_POLICY_ACTION_TYPE_HUB_BAN",
        }
    }
    /// Creates an enum from field names used in the ProtoBuf definition.
    pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
